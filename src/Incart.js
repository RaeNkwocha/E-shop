        ...
        <div className="incart">
         <div className="cart-img"><img style={{width:"40%",margin:"20px"}} src={image}></img></div>
            ...
            <div className="new-counter" style={{width:"20%",display:"flex"}}>
                            <div className="circle" ><i style={{margin:"10px"}} class="fa fa-minus"></i></div>
                            <div className="counter-holder" style={{margin:"auto",width:"20%",marginLeft:"0.5rem",marginRight:"0.5rem"}}><h3>1</h3></div>
                            <div className="circle" ><i style={{color:"#53B175",margin:"10px"}} class="fa fa-plus"></i></div>
                    </div>
                    <h6>{price}</h6>
